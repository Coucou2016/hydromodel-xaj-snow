...
Write-Host "2) Calibration refine (scipy from previous SCE-UA params)"
conda run -n $CondaEnv python scripts/run_xaj_calibration.py --config configs/real_caravan_camels_01013500_refine_scipy_from_kge_medium.yaml

Write-Host "3) Evaluation (test period)"
$caliDir = "results/real_caravan_camels_01013500_refine_scipy/xaj_mz_scipy"
